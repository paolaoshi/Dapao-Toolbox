...
class DapaoRealtimeImageAdjustNode:
    """
    实时图像调整节点
...
# 注册API路由 - 修改为唯一的路由名称
@PromptServer.instance.routes.post("/dapao_toolbox/realtime_image_adjust/apply")
...
NODE_CLASS_MAPPINGS = {
    "DapaoRealtimeImageAdjustNode": DapaoRealtimeImageAdjustNode
}
